...
<head>
  ...
  <script src="/test/js/jquery.backstretch.js"></script>
  <script src="/test/js/page.js"></script>
  <script src="https://unpkg.com/imagesloaded@4/imagesloaded.pkgd.min.js"></script>
  <script src="/test/js/wookmark.min.js"></script>
  <link rel="stylesheet" href="/test/css/gallery.css">
  <% If InStr(GC_Agent,"Mobile")>0 Or InStr(GC_Agent,"mobile")>0 Then %>
  ...
  <%
	...
	%>
	<link rel="stylesheet" href="/test/css/mobile.css">
	<%Else%>
